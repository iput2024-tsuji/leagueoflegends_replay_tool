...
- The microphone follows the device and enabled/disabled settings selected in the application, as before, and is recorded on the same track 1 as game audio.
