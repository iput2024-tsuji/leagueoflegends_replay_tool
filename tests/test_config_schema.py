from src import config_schema, recordtest

SHARED_RECORDTEST_DEFAULTS = (
    "DEFAULT_OBS_PASSWORD_LENGTH",
    "DEFAULT_OBS_SCENE_NAME",
    "DEFAULT_OBS_SOURCE_NAME",
    "DEFAULT_OBS_SOURCE_COLOR",
    "LEGACY_OBS_SOURCE_COLOR_BLUE",
    "DEFAULT_OBS_WINDOW_CAPTURE_NAME",
    "DEFAULT_OBS_WINDOW_CAPTURE_WINDOW",
    "DEFAULT_OBS_WINDOW_CAPTURE_METHOD",
    "DEFAULT_OBS_GAME_CAPTURE_NAME",
    "DEFAULT_OBS_LEGACY_GAME_CAPTURE_WINDOW",
    "DEFAULT_OBS_DIR",
    "DEFAULT_BIN_DIR",
    "DEFAULT_RECORDINGS_DIR",
    "DEFAULT_JSON_DIR",
    "DEFAULT_CHAMPION_ICONS_DIR",
    "DEFAULT_CHAMPION_ALIASES_PATH",
    "DEFAULT_OBS_HOST",
    "DEFAULT_OBS_PORT",
    ...
    "DEFAULT_OBS_BASE_WIDTH",
    "DEFAULT_OBS_BASE_HEIGHT",
    "DEFAULT_OBS_OUTPUT_WIDTH",
    ...
    "DEFAULT_AUDIO_MIC_INPUT_NAME",
    "DEFAULT_AUDIO_DEVICE_ID",
    "DEFAULT_AUDIO_DEVICE_NAME",
    "DEFAULT_AUDIO_MIC_VOLUME_DB",
    "DEFAULT_AUDIO_MIC_MUTE",
)


def test_recordtest_shared_config_defaults_match_schema():
    for name in SHARED_RECORDTEST_DEFAULTS:
        assert getattr(recordtest, name) == getattr(config_schema, name)

    assert recordtest.MANAGED_AUDIO_INPUTS == config_schema.MANAGED_AUDIO_INPUTS
