...
@pytest.mark.parametrize(
    ...
    [
        ...
        "downloads/OBS-Studio-32.1.2-Windows-x64.tar.gz",
        "downloads/ffmpeg.zip",
        "downloads/FFMPEG.7Z",
        "downloads/obs-studio.zip",
        "downloads/OBS-STUDIO.EXE",
        "downloads/ffmpeg_8.1_win64_gpl.zip",
        "downloads/obs-studio.32.1.2.windows.x64.installer.exe",
        "runtime/ffmpeg_8.1_win64/bin/codec.dll",
        "runtime/OBS-Studio.32.1.2.Windows.x64/data/plugin.dll",
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "docs/ffmpeg-release-notes.md",
        "downloads/ffmpeg-python.zip",
        "downloads/ffmpeg-release-notes.zip",
        "downloads/obs-studio-user-guide.zip",
        "downloads/obs-studio-setup-guide.zip",
        "downloads/not-ffmpeg.zip",
    ],
)
